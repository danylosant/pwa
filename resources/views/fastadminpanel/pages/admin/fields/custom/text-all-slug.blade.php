<template id="field-text-all-slug">
...
<script>
app.component('field-text-all-slug', {
	template: '#field-text-all-slug',
	...
	mounted() {
		...
		if (!this.value) {
			...
			Observer.add('field_title_changed', this.changeSlug)
		}
	},
	unmounted() {

		Observer.remove('field_title_changed', this.changeSlug)
	},
	methods: {
		check() {
		...
		changeSlug(title, table, parentId) {

			if (this.table == table && this.parent_id == parentId) {
